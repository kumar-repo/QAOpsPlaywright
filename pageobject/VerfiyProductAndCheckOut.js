...
class VerifyProductAndCheckOut {
    ...
    async checkProductAndCheckOut(productName) {
    ...
    async enterBillingInfo(cardNumber, expMonth, expYear, nameOnCard, couponCode, cvv) {
    ...
    async shippingCountrySelection(countryName) {
